...
/**
 * Simple filter which performs a default extraction of data from the
 * description lines of FASTA files. Behaviour is similar to
 * DefaultDescriptionReader in the old I/O framework.
 * 
 * @author Thomas Down
 * @since 1.1
 */
...
public class FastaDescriptionLineParser extends SequenceBuilderFilter {
	...
	public static class Factory implements SequenceBuilderFactory, Serializable {
		...
		public SequenceBuilder makeSequenceBuilder() {
			return new FastaDescriptionLineParser(delegateFactory
					.makeSequenceBuilder());
		}
	}
	...
	public void addSequenceProperty(Object key, Object value)
		...
		if (FastaFormat.PROPERTY_DESCRIPTIONLINE.equals(key)) {
			...
			if (toke.hasMoreTokens()) {
				getDelegate().addSequenceProperty("description",
						toke.nextToken("******"));
			}
		}
	}
