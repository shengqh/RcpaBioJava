...
import cn.ac.rcpa.bio.database.AccessNumberParseException;
 ...
 * 窗口 > 首选项 > Java > 代码生成 > 代码和注释
 */
public class GetEntriesXML {

  public static void getEntriesXMLFromFasta(String fastaFilename,
                                            SequenceDatabaseType dbType) throws
      AccessNumberParseException, BioException, SQLException, IOException,
    ...
    entryset.marshal(new FileWriter(fastaFilename + ".xml"));
  ...
  public static void main(String[] args) throws Exception {
    ...
    GetEntriesXML.getEntriesXMLFromFasta(fastaFilename, dbType);
  }
}
